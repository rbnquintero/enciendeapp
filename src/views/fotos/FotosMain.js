...
import FotosAlbums from './FotosAlbums'

class FotosMain extends Component {
  ...
  render() {
    return (
      <Navigator
        ...
        initialRoute={{ name:'Inicio', title:'Inicio', component: FotosAlbums }}
